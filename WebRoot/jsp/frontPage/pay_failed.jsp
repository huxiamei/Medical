...
function refer(){ 
if(t==0){ 
location="recharge.html"; //#设定跳转的链接地址 
} 
...
<body>
  <div class="containner">
	...
	<div class="mainContent">
	   <div class="tipIcon">
	  <img src="images/failed.png" width="200" height="200"/>
	  <p class="tipWord_failed"><strong>余额不足，付款失败!</strong></p>
	  <p class="tipJump_failed"><strong>页面正在跳转<span class="jumpNumer_failed" id="jumpNumer">5</span>.....</strong></p>
	  </div>
