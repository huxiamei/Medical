...
<script src="${basepath }/js/DoctorPatientCtr.js" type="text/JavaScript"></script> 
	...
	<!--main conten-->
      <div class="mainContent">
		...
		<div class="doctor_mainTop">
		  ...
		  <p class="thisLocation">当前位置>我的病人</p>
		</div>
		<div class="mainMid">
		<!--leftSide -->
		...
		<div class="rightContent">
		    <div class="msgTab">
			<!-- 基本信息-->
			<p class="basicInfoTitle"><b>我的病人</b></p>
			</div>
...
<script type="text/x-jquery-tmpl" id="PatientInfoTemplate">
        <tr>
		<td id="patient_id">\${patient_id}</td>
		<td id="patient_name">\${patient_name}</td>
		<td id="patient_gender">\${patient_gender}</td>
		<td id="patient_birthday">\${patient_birthday}</td>
		<td id="patient_email">\${patient_email}</td>
		<td id="patient_tel">\${patient_tel}</td>
		<td id="patient_hospital">\${patient_hospital}</td>
		<td id="patient_department">\${patient_department}</td>
        <td> <a href="${basepath }/applyConsultation/showConsultationTable/\${patient_id}">申请会诊</a></td>
		</tr>
</script>
</body>
</html>