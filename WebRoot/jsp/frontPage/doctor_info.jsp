...
<script src="${basepath }/js/frontpageDoctorCtr.js" type="text/JavaScript"></script> 
<title>Doctor</title>
	...
	<!--main conten-->
      <div class="mainContent">
		...
		<div class="doctor_mainTop">
		  <!--<div class="docPhoto"><img src="${basepath }/images/doctor.png" width="150" height="200"/></div>-->
		...
		<div class="rightContent">
			...
			<div class="basicInfo_received">
			    ...
			    <table border="0">
				    ...
				    <tr>
					    <td id="currentDocId">${sessionScope.CurrentUser.id}</td>
						<td id="currentDocName"></td>
						<td id="currentDocsex"></td>
						<td id="currentDocdate"></td>
						<td id="currentDocemail"></td>
						<td id="currentDoctel"></td>
						<td id="currentDochospital"></td>
						<td id="currentDocdepartment"></td>
				    </tr>
				</table>
				<hr/>
